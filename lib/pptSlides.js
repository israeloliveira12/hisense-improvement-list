...
export function addDepartmentsSlide(pptx, stats, lang = "en") {
  ...
  const headerRow = [
    ...
    options: {
      bold: true, color: TEXT_MUTED, fill: { color: BG_LIGHT }, fontSize: 9, fontFace: "Arial",
  ...
  const bodyRows = deptos.map((d) => {
    ...
    return [
      { text: txt(sv(lang, d.label)), options: { fontSize: 10, bold: true, fontFace: "Arial", color: TEXT_DARK, align: "left", fill: { color: "FFFFFF" } } },
      { text: String(d.total), options: { fontSize: 10, fontFace: "Arial", color: TEXT_MUTED, bold: true, align: "left", fill: { color: "FFFFFF" } } },
      { text: String(d.open), options: { fontSize: 9.5, fontFace: "Arial", color: AMBER, bold: true, align: "left", fill: { color: AMBER_TINT } } },
      { text: String(d.closed), options: { fontSize: 9.5, fontFace: "Arial", color: GREEN, bold: true, align: "left", fill: { color: GREEN_TINT } } },
      { text: String(d.delayed), options: { fontSize: 10, fontFace: "Arial", color: d.delayed ? RED : "9490A0", bold: !!d.delayed, align: "left", fill: { color: "FFFFFF" } } },
      { text: `${taxa}%`, options: { fontSize: 10, fontFace: "Arial", color: TEXT_MUTED, bold: true, align: "left", fill: { color: "FFFFFF" } } },
  ...
  if (!bodyRows.length) {
    ...
    const rowH = Math.min(0.4, alturaDisponivel / (bodyRows.length + 1));
