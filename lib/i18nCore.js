...
export const DICT = {
  pt: {
    ...
    pptDeck: {
      ...
      deptDashboardTitle: "Ações por Departamento", deptDashboardSubtitle: "Indicadores por departamento — {n} ações",
    },
    excel: {
  ...
  en: {
    ...
    pptDeck: {
      ...
      overviewTitle: "Improvement Overall", overviewSubtitle: "Overall summary — {n} actions",
      ...
      deptDashboardTitle: "Action by Department", deptDashboardSubtitle: "Indicators by department — {n} actions",
    },
    excel: {
  ...
  zh: {
    ...
    pptDeck: {
      ...
      deptDashboardTitle: "各部门行动", deptDashboardSubtitle: "各部门指标 — 共 {n} 项行动",
