// Parte PURA do i18n -- sem React, sem "use client".
//
// Existe separado de i18n.js por um motivo concreto: i18n.js tem
// "use client" no topo, e no App Router isso faz o Next trocar TODOS os
// exports daquele arquivo por referencias de cliente quando o SERVIDOR
// importa dele. Na pratica, `translate` chegava no servidor como um objeto
// (nao uma funcao) e a geracao do .xlsx/.pptx quebrava com
// "(0 , X.Y) is not a function" -- minificado, sem pista nenhuma de onde
// vinha. Tudo que roda nos dois lados (dicionario, translate,
// translateValue, formatDateISO) mora aqui; i18n.js so reexporta e cuida
// do Context/hook do React.
...
export const DICT = {
  pt: {
    ...
    login: {
      subtitle: "Entre com a senha compartilhada da equipe.",
      senha: "Senha", entrando: "Entrando…", entrar: "Entrar",
    ...
    pres: {
      ...
      enviarFoto: "Clique ou arraste pra enviar", enviando: "Enviando…", uploadFalhou: "Falha no upload",
      fotosFalharamNoDeck: "O arquivo foi baixado, mas algumas fotos/vídeos não puderam ser incluídos",
      ...
      rotacionarFoto: "Girar 90°", documento: "Documento",
    ...
    pptDeck: {
      ...
      overviewTitle: "Dashboard Principal", overviewSubtitle: "Resumo geral — {n} ações",
      ...
      deptDashboardTitle: "Dashboard Departamentos", deptDashboardSubtitle: "Indicadores por departamento — {n} ações",
    },
    excel: {
    ...
    edit: {
      ...
      fieldSpmLink: "Link SPM", fieldSpmLinkHint: "Cola aqui o link da ação no SPM — com isso preenchido, o número da ação vira clicável na Apresentação e no PPT baixado.",
    ...
    dash: {
      ...
      mostrarRecusados: "Mostrar recusados", etapaPendenteAnalise: "Em Análise",
      ...
      quanto: "Quanto", quando: "Quando", fornecedor: "Fornecedor",
      ...
      statusAcoes: "Status das ações", openVsClosed: "Aberto vs. Fechado",
      porDepto: "Ações Abertas por Departamento", deptSub: "Dept. in charge",
      investimento: "Investimento — aprovado vs. recusado vs. em análise",
      itensSolicitados: "{n} itens · {valor} solicitados no total",
      aprovado: "Aprovado", recusado: "Recusado", pendente: "Em Análise", parcial: "Parcial",
      ...
      forecastMatrizTitulo: "Previsão por semana e departamento", forecastMatrizSub: "Mesma janela de 12 semanas, quebrada por departamento — vermelho = atrasado. Passe o mouse numa célula pra ver quais ações.",
    },
  },
  en: {
    ...
    login: {
      subtitle: "Sign in with the team's shared password.",
      senha: "Password", entrando: "Signing in…", entrar: "Sign in",
      erroGenerico: "Couldn't sign in.",
    },
    pres: {
      ...
      enviarFoto: "Click or drag to upload", enviando: "Uploading…", uploadFalhou: "Upload failed",
      fotosFalharamNoDeck: "The file was downloaded, but some photos/videos could not be included",
      ...
      rotacionarFoto: "Rotate 90°", documento: "Document",
    ...
    pptDeck: {
      ...
      overviewTitle: "Main Dashboard", overviewSubtitle: "Overall summary — {n} actions",
      ...
      deptDashboardTitle: "Departments Dashboard", deptDashboardSubtitle: "Indicators by department — {n} actions",
    },
    excel: {
    ...
    edit: {
      ...
      fieldDescription: "Description", fieldExpectation: "Expectation", fieldAbrangency: "Abrangency",
      fieldFactoryComment: "Factory Comment", fieldHisenseComment: "Hisense Comment",
      fieldSpmLink: "SPM Link", fieldSpmLinkHint: "Paste the action's SPM link here — once filled in, the action number becomes clickable in the Presentation and in the downloaded PPT.",
    ...
    dash: {
      ...
      mostrarRecusados: "Show declined", etapaPendenteAnalise: "Under Analysis",
      ...
      quanto: "Amount", quando: "When", fornecedor: "Supplier",
      ...
      investimento: "Investment — approved vs. declined vs. under analysis",
      itensSolicitados: "{n} items · {valor} requested in total",
      aprovado: "Approved", recusado: "Declined", pendente: "Under Analysis", parcial: "Partial",
      ...
      forecastMatrizTitulo: "Forecast by week and department", forecastMatrizSub: "Same 12-week window, broken down by department — red = overdue. Hover a cell to see which actions.",
    },
  },
  zh: {
    ...
    login: {
      subtitle: "请输入团队共用密码登录。",
      senha: "密码", entrando: "正在登录…", entrar: "登录",
      erroGenerico: "登录失败。",
    },
    pres: {
      ...
      enviarFoto: "点击或拖拽上传", enviando: "上传中…", uploadFalhou: "上传失败",
      fotosFalharamNoDeck: "文件已下载，但部分照片/视频未能包含在内",
      ...
      rotacionarFoto: "旋转 90°", documento: "文档",
      excluirAcao: "删除行动",
    ...
    pptDeck: {
      ...
      overviewTitle: "主仪表盘", overviewSubtitle: "总体概览 — 共 {n} 项行动",
      ...
      deptDashboardTitle: "部门仪表盘", deptDashboardSubtitle: "各部门指标 — 共 {n} 项行动",
    ...
    edit: {
      ...
      fieldSpmLink: "SPM 链接", fieldSpmLinkHint: "粘贴该行动在 SPM 系统中的链接——填写后，行动编号在演示和下载的 PPT 中会变为可点击。",
      semPassos: "尚未添加步骤。",
    ...
    dash: {
      ...
      investimento: "投资 — 批准 vs. 拒绝 vs. 审核中",
      itensSolicitados: "{n} 项 · 共申请 {valor}",
      aprovado: "已批准", recusado: "已拒绝", pendente: "审核中", parcial: "部分批准",
      ...
      forecastMatrizTitulo: "按周和部门预测", forecastMatrizSub: "同样的12周窗口，按部门细分 — 红色表示已逾期。将鼠标悬停在单元格上可查看具体行动。",
    },
  },
};
