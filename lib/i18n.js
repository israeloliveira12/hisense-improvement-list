...
const DICT = {
  pt: {
    ...
    edit: {
      ...
      fieldAudit: "Audit", fieldProcess: "Process", fieldOccur: "Occur. date", fieldTarget: "Target",
      valueTarget: "Target", valueNonTarget: "Non-target", targetHint: "(calculado — ver Dashboard)",
      ...
      notaInvestimento: "Adicionar um item de investimento novo ainda não é possível pelo site — edite direto na planilha por enquanto.",
      fieldItemRequired: "Item *", fieldDeadline: "Deadline", investYes: "Sim", investNo: "Não",
    },
    db: {
      ...
      col: { no: "No.", item: "Item", dept: "Dept. in charge", person: "Líder da Ação", status: "Status", deadline: "Deadline", investment: "Investment" },
  ...
  en: {
    ...
    edit: {
      ...
      fieldAudit: "Audit", fieldProcess: "Process", fieldOccur: "Occur. date", fieldTarget: "Target",
      valueTarget: "Target", valueNonTarget: "Non-target", targetHint: "(calculated — see Dashboard)",
      ...
      notaInvestimento: "Adding a new investment item isn't possible from the site yet — edit directly in the spreadsheet for now.",
      fieldItemRequired: "Item *", fieldDeadline: "Deadline", investYes: "Yes", investNo: "No",
    },
    db: {
      ...
      col: { no: "No.", item: "Item", dept: "Dept. in charge", person: "Action Leader", status: "Status", deadline: "Deadline", investment: "Investment" },
  ...
  zh: {
    ...
    edit: {
      ...
      fieldAudit: "审核员", fieldProcess: "工序", fieldOccur: "发生日期", fieldTarget: "Target",
      valueTarget: "Target", valueNonTarget: "Non-target", targetHint: "（自动计算 — 见仪表盘）",
      ...
      etapaAntiga: "旧值",
      notaInvestimento: "网站上暂时无法添加新的投资项目 — 请直接在表格中编辑。",
      fieldItemRequired: "项目 *", fieldDeadline: "截止日期", investYes: "是", investNo: "否",
    },
    db: {
      ...
      col: { no: "编号", item: "项目", dept: "负责部门", person: "行动负责人", status: "状态", deadline: "截止日期", investment: "投资" },
...
const LanguageContext = createContext({ lang: "pt", setLang: () => {}, t: (k) => k, formatDate: (iso) => iso || "", dateInputLang: "pt-BR" });
...
export function LanguageProvider({ children }) {
  ...
  return (
    <LanguageContext.Provider value={{ lang, setLang, t, formatDate, dateInputLang: DATE_INPUT_LANG[lang] }}>
      {children}
