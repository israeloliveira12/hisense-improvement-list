...
const DICT = {
  pt: {
    ...
    dash: {
      ...
      mostrarRecusados: "Mostrar recusados", etapaPendenteAnalise: "Pendente – Em Análise",
      kanbanTitulo: "Acompanhamento por etapa", kanbanSub: "Itens de investimento agrupados por onde estão no processo",
  ...
  en: {
    ...
    dash: {
      ...
      mostrarRecusados: "Show declined", etapaPendenteAnalise: "Pending – Under Analysis",
      kanbanTitulo: "Stage tracking", kanbanSub: "Investment items grouped by where they stand in the process",
  ...
  zh: {
    ...
    dash: {
      ...
      mostrarRecusados: "显示已拒绝", etapaPendenteAnalise: "待定 - 审核中",
      kanbanTitulo: "按阶段跟踪", kanbanSub: "投资项目按所处阶段分组",
