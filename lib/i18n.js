...
const DICT = {
  pt: {
    ...
    edit: {
      ...
      fieldId: "ID (No.)", fieldItem: "Item", fieldDept: "Dept. in charge", fieldPerson: "Person in charge",
  ...
  zh: {
    ...
    edit: {
      ...
      fieldId: "编号 (No.)", fieldItem: "项目", fieldDept: "负责部门", fieldPerson: "负责人",
      ...
      semPassos: "尚未添加步骤。",
      colAcao: "行动", colResponsavel: "负责人", colPrazo: "日期", colStatus: "状态",
