...
const DICT = {
  pt: {
    ...
    pres: {
      ...
      baixarPpt: "Baixar PPT", baixarTudo: "Baixar tudo", apresentar: "Apresentar", buscar: "Buscar ação…",
    ...
    dash: {
      ...
      potencialNota: "Ainda dá pra fechar {n} ações sem depender de nova aprovação (sem investimento ou com investimento já aprovado) — fechando todas, a conclusão sai de {pctAtual}% para {pctPotencial}%.",
  ...
  en: {
    ...
    pres: {
      ...
      baixarPpt: "Download PPT", baixarTudo: "Download all", apresentar: "Present", buscar: "Search action…",
    ...
    dash: {
      ...
      potencialNota: "{n} actions can still be closed without waiting on new approval (no investment needed, or investment already approved) — closing them all takes completion from {pctAtual}% to {pctPotencial}%.",
  ...
  zh: {
    ...
    pres: {
      ...
      baixarPpt: "下载 PPT", baixarTudo: "下载全部", apresentar: "开始演示", buscar: "搜索行动…",
    ...
    dash: {
      ...
      podeFechar: "可以关闭",
      potencialNota: "还有 {n} 项行动无需等待新的审批即可关闭（不需要投资，或投资已获批准）——全部关闭后，完成率将从 {pctAtual}% 提升到 {pctPotencial}%。",
