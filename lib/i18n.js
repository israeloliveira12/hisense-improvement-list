...
// agrupamento. Ficam em ingles/pt fixo na planilha de proposito -- e o
// formato oficial gravado e o que vai pro .pptx -- mas na TELA precisam
// aparecer no idioma escolhido. Use `tv()` do useLanguage pra isso.
...
export function LanguageProvider({ children }) {
  ...
  function tv(valor) {
    const chave = VALORES_DO_SISTEMA[String(valor ?? "").trim()];
