...
// O client OAuth2 "cru" (sem o wrapper `drive.*`) -- precisa dele
// separado pra pegar um access token fresco na mao (ver
// criarSessaoUploadResumavel em lib/googleDrive.js, que faz uma chamada
// HTTP direta que o SDK do googleapis nao expoe).
...
export function getAuthorizedDriveClient() {
  return google.drive({ version: "v3", auth: getAuthorizedOAuthClient() });
}
